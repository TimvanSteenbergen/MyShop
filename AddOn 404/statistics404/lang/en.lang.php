...
$strings['MWEditor title'] = 'Information on non-available pages and empty searches';
$strings['MWEditor titletext'] = 'This Myshop-Addon shows you every time when and where visitors of your shop have come across a non-existing page and where they came from.';
$strings['Shopid'] = 'Shopid';
$strings['Noresult'] = 'Noresult';
$strings['SendDailyEmail'] = 'Send a daily mail with (max 500) urls to: ';
$strings['YourEmail'] = 'Your emailaddress';
$strings['Time'] = 'Time';
$strings['number'] = '#';
$strings['url'] = 'url';
$strings['referer'] = 'referer';
$strings['no referer'] = 'referer unknown';
$strings['selectall'] = 'Select all urls';
$strings['selectnone'] = 'Deselect all urls';
$strings['delete_allselected'] = 'Delete all selected urls';
$strings['status_newtoseen'] = 'Set this url to status \'This one I have seen already\'';
$strings['status_newtoseen_allselected'] = 'Set all selected urls to status \'This one I have seen already\'';
$strings['status_seentonew'] = 'Set this url to status \'This one I have not yet seen\'';
$strings['status_seentonew_allselected'] = 'Set all selected urls to status \'This one I have not yet seen\'';
$strings['selectfirstpage'] = 'Go to the first page';
$strings['selectpreviouspage'] = 'Go to the previous page';
$strings['selectspecificpage'] = 'Go to specific pagenumber';
$strings['selectnextpage'] = 'Go to the next page';
$strings['selectlastpage'] = 'Go to last page';
$strings['you are on page x of y'] = 'You are on page %s of %s';
$strings['show'] = 'Show ';
$strings['urls on the page'] = 'lines on one page';
$strings['grouped'] = 'grouped per url';
$strings['detailed'] = 'each url separately';
$strings['click_to_sort'] = 'to sort: click a columnheader';
$strings['both_open_and_closed_eyes'] = 'both open and closed eyes';
$strings['only_open_eyes'] = 'only open eyes';
$strings['only_closed_eyes'] = 'only closed eyes';
/***
  DAY NAMES
