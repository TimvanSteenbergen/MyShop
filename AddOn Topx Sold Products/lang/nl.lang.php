...
*
* @author Tim van Steenbergen <tim@tieka.nl>
* @translator <tim@tieka.nl>
* @version 1
* @package Languages
*
* Copyright (C) Tieka
...
// INSTRUCTIONS
///////////////////////////////////////////////////////////
// This file contains all of the strings that are used throughout Statistics404.
//
// To make Statistics404 available in another language, simply translate each
//  of the following strings into the appropriate one for the language. 
//
...
//Mijnwinkel editors text's
$strings['MWEditor title'] = 'Informatie over niet gevonden pagina\'s en lege zoekresultaten';
$strings['MWEditor titletext'] = 'Deze Mijnwinkel-Addon laat u zien wanneer en waar de bezoekers van uw winkel een niet bestaande pagina bezochten en waar ze vandaan kwamen.';
$strings['Shopid'] = 'Winkelnummer';
$strings['Noresult'] = 'Noresult';
$strings['SendDailyEmail'] = 'Stuur dagelijks een mail met (max 500) urls naar: ';
$strings['YourEmail'] = 'uw emailadres';
$strings['Time'] = 'Tijdstip';
$strings['number'] = '#';
$strings['url'] = 'url';
$strings['referer'] = 'referer';
$strings['no referer'] = 'referer onbekend';
$strings['selectall'] = 'Selecteer alle urls';
$strings['selectnone'] = 'Deselecteer alle urls';
$strings['delete_allselected'] = 'Verwijder alle geselecteerde urls';
$strings['status_newtoseen'] = 'Zet deze url op status \'Heb ik al gezien\'';
$strings['status_newtoseen_allselected'] = 'Zet alle geselecteerde urls op status \'Heb ik al gezien\'';
$strings['status_seentonew'] = 'Zet deze url op status \'Heb ik nog niet gezien\'';
$strings['status_seentonew_allselected'] = 'Zet alle geselecteerde urls op status \'Heb ik nog niet gezien\'';
$strings['selectfirstpage'] = 'Ga naar de eerste pagina';
$strings['selectpreviouspage'] = 'Ga naar de vorige pagina';
$strings['selectspecificpage'] = 'Ga naar paginanummer';
$strings['selectnextpage'] = 'Ga naar volgende pagina';
$strings['selectlastpage'] = 'Ga naar laatste pagina';
$strings['you are on page x of y'] = 'Je bent op pagina %s van de %s';
$strings['show'] = 'Toon ';
$strings['urls on the page'] = 'regels op &eacute;&eacute;n pagina';
$strings['grouped'] = 'gegroepeerd per url';
$strings['detailed'] = 'iedere url apart';
$strings['click_to_sort'] = 'sorteren: klik op een kolomkop';
$strings['both_open_and_closed_eyes'] = 'zowel open als gesloten ogen';
$strings['only_open_eyes'] = 'alleen de open ogen';
$strings['only_closed_eyes'] = 'alleen de gesloten ogen';
/***
  DAY NAMES
