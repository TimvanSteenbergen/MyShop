<?php
    ...
    class MyshopXMLException extends ErrorException {
    ...
    class MyshopEmptyRequestBodyException extends ErrorException {
    ...
    class MyshopSignatureException extends ErrorException {
